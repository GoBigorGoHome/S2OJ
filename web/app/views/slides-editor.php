<!-- 思路: $editor->cur_data 里存的是从数据库读到的数据。要把这些数据喂给 markslides
-->
<form method="post" class="form-horizontal" id="form-<?= $editor->name ?>" enctype="multipart/form-data">
	...
	<?php if ($editor->show_editor) : ?>
		<div id="div-<?= $editor->name ?>_content_md">
			<!-- 盛放编辑器的地方 -->
			<div id="div_container-<?= $editor->name ?>_content_md" style="height: 100%">
	...
	<?php endif ?>
	<div class="row mt-2" id="buttons-below-slides-editor">
		<div class="col-sm-6">
...
<script type="text/javascript">
	...
	slides_editor_init("<?= $editor->name ?>");
</script>